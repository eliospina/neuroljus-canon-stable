...
Cada persona autista es un universo único. Yo ayudo a sostener observación, memoria y lenguaje cuando el cuidado necesita más claridad.`,
      ...
      mission: "Convertir el conocimiento cotidiano del cuidado en rutinas, observaciones y protocolos que apoyen salud, bienestar, investigación y robótica asistiva — primero para las personas autistas que más lo necesitan.",
      visionTitle: "Nuestra Visión",
      vision: "Un mundo donde la robotización del cuidado no reproduzca el guion neurotipico: familias, comunas, investigación e IA trabajando alrededor de la dignidad de quien no vive agendas dobles.",
      horizonTitle: "Horizonte a largo plazo",
      horizon: "NeuroLjus busca colaborar con robótica asistiva e infraestructura de cuidado cualificada: protocolos portables para humanos, hogares y robots, con la persona autista como beneficiaria — nunca el KPI del personal. Si la robotización tarda una generación o un siglo, el norte no cambia: el sistema de cuidado es para ellos. Apoyo diagnóstico clínico solo como horizonte con aliados cualificados.",
...
Each autistic person is a unique universe. I help hold observation, memory, and language when care needs more clarity.`,
      ...
      mission: "Turn everyday caregiving knowledge into routines, observations, and protocols that support health, wellbeing, research, and assistive robotics — first for autistic people who need care most.",
      visionTitle: "Our Vision",
      vision: "A world where the robotization of care does not reproduce the neurotypical script: families, municipalities, research, and AI working around the dignity of people who do not live double agendas.",
      horizonTitle: "Long-term horizon",
      horizon: "NeuroLjus seeks collaboration with assistive robotics and qualified care infrastructure: portable protocols for humans, homes, and robots, with the autistic person as beneficiary — never staff KPIs. If robotization takes a generation or a century, the north star does not change: the care system is for them. Clinical diagnostic support only as a horizon with qualified partners.",
...
Varje autistisk person är ett unikt universum. Jag hjälper till att bära observation, minne och språk när omsorgen behöver mer klarhet.`,
      ...
      mission: "Omvandla vardagens omsorgskunskap till rutiner, observationer och protokoll som stödjer hälsa, välbefinnande, forskning och assisterande robotik — först för autistiska personer som behöver omsorgen mest.",
      visionTitle: "Vår Vision",
      vision: "En värld där robotiseringen av omsorg inte reproducerar det neurotypiska manuset: familjer, kommuner, forskning och AI runt värdigheten hos dem som inte lever dubbla agendor.",
      horizonTitle: "Långsiktig horisont",
      horizon: "NeuroLjus söker samarbete med assisterande robotik och kvalificerad omsorgsinfrastruktur: portabla protokoll för människor, hem och robotar, med den autistiska personen som mottagare — aldrig personalens KPI. Om robotiseringen tar en generation eller ett sekel ändras inte norr: omsorgssystemet är till för dem. Kliniskt diagnostiskt stöd endast som horisont med kvalificerade partners.",
      methodTitle: "Metoden",
