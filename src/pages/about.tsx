...
Cada persona autista es un universo único. Yo solo ayudo a los cuidadores a observar con más estructura, más empatía y más respeto.`,
      ...
      ethicsTitle: "El marco ético",
      ethics: "El marco ético sostiene la ambición de NeuroLjus y la hace capaz de llegar lejos. La visión es grande, y por eso cualquier futura validación con personas, datos sensibles o posible uso clínico debe construirse junto a una universidad o institución responsable, con revisión ética en Suecia cuando corresponda, financiación adecuada y protección estricta de datos. El white paper fue enviado a universidades para buscar un laboratorio serio, regulado y científicamente acompañado.",
      contact: "Contacto",
...
Each autistic person is a unique universe. I only help caregivers observe with more structure, more empathy, and more respect.`,
      ...
      ethicsTitle: "The ethical framework",
      ethics: "The ethical framework carries NeuroLjus's ambition and makes it capable of going far. The vision is large, and that is why any future validation with people, sensitive data, or possible clinical use must be built with a university or responsible institution, Swedish ethical review when applicable, proper funding, and strict data protection. The white paper was sent to universities to seek a serious, regulated, scientifically accompanied lab.",
      contact: "Contact",
...
Varje autistisk person är ett unikt universum. Jag hjälper bara vårdgivare att observera med mer struktur, mer empati och mer respekt.`,
      ...
      ethicsTitle: "Det etiska ramverket",
      ethics: "Det etiska ramverket bär NeuroLjus ambition och gör den möjlig att bära långt. Visionen är stor, och därför behöver framtida validering med människor, känsliga data eller möjlig klinisk användning byggas tillsammans med universitet eller ansvarig institution, svensk etikprövning när det är tillämpligt, rätt finansiering och starkt dataskydd. White paper skickades till universitet för att söka ett seriöst, reglerat och vetenskapligt förankrat laboratorium.",
      contact: "Kontakt",
