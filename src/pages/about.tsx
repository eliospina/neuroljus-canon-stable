...
Cada persona autista es un universo único. Yo ayudo a sostener observación, memoria y lenguaje cuando el cuidado necesita más claridad.`,
      ...
      horizon: "NeuroLjus busca colaborar con robótica asistiva e infraestructura de cuidado cualificada: protocolos portables para humanos, hogares y robots, con la persona autista como beneficiaria — nunca el KPI del personal. Apoyo diagnóstico clínico solo como horizonte con aliados cualificados.",
...
Each autistic person is a unique universe. I help hold observation, memory, and language when care needs more clarity.`,
      ...
      horizon: "NeuroLjus seeks collaboration with assistive robotics and qualified care infrastructure: portable protocols for humans, homes, and robots, with the autistic person as beneficiary — never staff KPIs. Clinical diagnostic support only as a horizon with qualified partners.",
...
Varje autistisk person är ett unikt universum. Jag hjälper till att bära observation, minne och språk när omsorgen behöver mer klarhet.`,
      ...
      horizon: "NeuroLjus söker samarbete med assisterande robotik och kvalificerad omsorgsinfrastruktur: portabla protokoll för människor, hem och robotar, med den autistiska personen som mottagare — aldrig personalens KPI. Kliniskt diagnostiskt stöd endast som horisont med kvalificerade partners.",
      methodTitle: "Metoden",
