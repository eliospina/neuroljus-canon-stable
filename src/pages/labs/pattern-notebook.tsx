  ...
  const T = useMemo(
    () => ({
      ...
      es: {
        ...
        ctaObs: "Observation Method",
        disclaimer:
          "No es evaluación médica. Si la preocupación continúa: contacta atención sanitaria. Cinturones/bandas inalámbricas son un horizonte futuro de adaptadores — no un producto aquí.",
      },
    }),
    []
  );
