...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const system =
      ...
      "(1) /labs/nl-vision raw landmarks, (2) /labs/future-care-room Story Mode and Possible discomfort, (3) /labs/robot-interface protocol export, (4) /observation-method structured notes, (5) /labs/pattern-notebook local gesture→relief notes, (6) /labs/serious-incident local witness + txt/json export for Lex Sarah / IVO / lawyer (no camera detection). " +
