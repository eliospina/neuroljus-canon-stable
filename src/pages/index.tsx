  ...
  const T = useMemo(
    () => ({
      sv: {
        ...
        modCareBody: "Interaktiv miljösimulering. Ljus, ljud, avstånd → levande protokoll.",
      ...
      en: {
        ...
        modCareTitle: "Care Room",
        modCareBody: "Interactive environment simulation. Light, sound, distance → live protocol.",
        modProtoTitle: "Protocol Workspace",
      ...
      es: {
        ...
        modCareTitle: "Care Room",
        modCareBody: "Simulación interactiva del entorno. Luz, sonido, distancia → protocolo vivo.",
        modProtoTitle: "Protocol Workspace",
