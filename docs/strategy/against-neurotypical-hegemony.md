...
| Lab **/labs/serious-incident**: local save + **.txt / .json export** for Lex Sarah / IVO / lawyer under **authorized witness / reporting duty** | Pretending Neuroljus *is* IVO as an institution, or camera abuse detection |
